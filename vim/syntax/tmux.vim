...
\ prefix2 prompt-command-cursor-style prompt-cursor-color prompt-cursor-colour
...
\ session-renamed session-status-current-style session-status-style
...
\ tiled-layout-max-columns update-environment user-keys

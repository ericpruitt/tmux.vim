...
\ default-terminal editor escape-time exit-empty activity-action
...
\ display-time exit-unattached extended-keys focus-events history-file
\ history-limit key-table lock-after-time lock-command message-command-style
\ message-limit aggressive-resize allow-rename alternate-screen
\ automatic-rename automatic-rename-format clock-mode-colour
\ clock-mode-style copy-mode-current-match-style copy-mode-mark-style
\ copy-mode-match-style main-pane-height main-pane-width message-style
...
\ pane-base-index pane-border-format pane-border-lines pane-border-status

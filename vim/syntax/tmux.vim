...
\ load-buffer loadb lock lock-client lock-server lock-session lockc
\ last-pane lastp locks ls last-window last lsb lsc delete-buffer deleteb
\ lscm lsk lsp lsw move-pane move-window movep movew new new-session
